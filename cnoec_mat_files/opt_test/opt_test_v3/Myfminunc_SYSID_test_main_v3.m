...
alfa = zeros(N_points,1); %optimal parameter to be selected for the optimal trajectory if all == 0 x_cen = x_in and y_cen = y_in
...
y_out_kp1=y_out(ind+1);
y_out_k = y_out(ind);
th = [x_in_kp1;x_out_kp1;x_in_k;x_out_k;y_in_kp1;y_out_kp1;y_in_k;y_out_k,alfa_k];
